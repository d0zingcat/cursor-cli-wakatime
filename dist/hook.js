  ...
  "node_modules/adm-zip/adm-zip.js"(exports2, module2) {
    ...
    module2.exports = function(input, options2) {
      ...
      function fixPath(zipPath) {
        ...
        return join5(".", normalize2(sep + zipPath.split("\\").join(sep) + sep));
      }
...
function resolveTranscriptPath(inp) {
  ...
  if (!conversationId) return explicit || void 0;
...
async function runWakatime(args, label) {
